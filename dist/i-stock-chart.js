...
(function (StockChart) {
    ...
    function drawKLine(options) {
        var defaultOptions = {
            ...
            popWindowKeys: {color: '#939393', keys: ['日期:', '开盘:', '最高:', '最低:', '收盘:', '涨跌:']}
        };
...
(function (StockChart) {
    var ITrendLine = (function (_super) {
        ...
        ITrendLine.prototype.popWindowDatas = function (index) {
            var _a = this, prices = _a.prices, volumes = _a.volumes, times = _a.times, preClosePrice=_a.preClosePrice;
    ...
    function drawTrendLine(options) {
        var defaultOptions = {
            ...
            popWindowValueColor: 'rgba(0,0,0,1)',
            popWindowKeys: {color: '#939393', keys: ['时间:', '现价:', '涨跌:', '现量:']}
        };
        options = StockChart.mixins({}, defaultOptions, options);
